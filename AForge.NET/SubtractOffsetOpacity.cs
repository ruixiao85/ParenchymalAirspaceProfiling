...
namespace AForge.Imaging.Filters
{
	...
	/// 
	public sealed class SubtractOffsetOpacity : BaseInPlaceFilter2
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="SubtractOffsetOpacity"/> class.
		/// </summary>
		public SubtractOffsetOpacity(int offset = 0, float opacity = 1.0f)
		{
			InitFormatTranslations(); Offset=offset; Opacity=opacity;
		}
		...
		/// 
		public SubtractOffsetOpacity(Bitmap overlayImage, int offset = 0, float opacity = 1.0f)
			 : base(overlayImage)
		{
			InitFormatTranslations(); Offset=offset; Opacity=opacity;
		}
		...
		/// 
		public SubtractOffsetOpacity(UnmanagedImage unmanagedOverlayImage, int offset = 0, float opacity = 1.0f)
			...
			if (
				...
				for (int y = 0; y<height; y++) {
					...
					for (int x = 0; x<lineSize; x++, ptr++, ovr++) {
						v=(int)((*ptr-*ovr+Offset)*Opacity+*ptr*(1-Opacity));
