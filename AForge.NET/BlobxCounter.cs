...
namespace AForge.Imaging
{
	...
	/// </remarks>
	/// 
	public class BlobxCounter : BlobxCounterBase
	{
		...
		/// 
		public BlobxCounter(Bitmap image) : base(image) { }
		...
		/// 
		public BlobxCounter(BitmapData imageData) : base(imageData) { }
		...
		/// 
		public BlobxCounter(UnmanagedImage image) : base(image) { }
