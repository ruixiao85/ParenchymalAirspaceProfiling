...
namespace AForge.Imaging.Filters
{
	...
	/// <seealso cref="SubtractOffsetOpacity"/>
	/// 
	public sealed class BinaryOR : BaseInPlaceFilter2
	{
		...
		/// 
		public BinaryOR(Bitmap overlayImage)
				: base(overlayImage)
		{
			InitFormatTranslations();
		}
		...
		/// 
		public BinaryOR(UnmanagedImage unmanagedOverlayImage)
