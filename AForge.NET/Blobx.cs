...
namespace AForge.Imaging
{
	...
	public class Blobx
	{
		...
		/// </summary>
		/// 
		/// <remarks><para>The property equals to number of pixels of each blob
		/// that is either on the edge of the blob or whole image.</para></remarks>
		/// 
		...
		/// or <see cref="BlobCounterBase.ExtractBlobsImage( UnmanagedImage, Blob, bool )"/> method.</para></remarks>
		/// 
		public Blobx(int id, Rectangle rect)
		{
			this.id=id;
			this.rect=rect;
		}
